...
const Hero = () => {
  ...
  return (
    <motion.div
      className="relative md:h-[800px] bg-black md:bg-hero-pattern bg-cover bg-no-repeat flex justify-center"
    ...
    >
      <div className="relative">
        ...
        <motion.img
          ...
          initial={{ y: "100vh" }}
          animate={{ rotate: 360, y: "-85vh", x: "80vh" }}
